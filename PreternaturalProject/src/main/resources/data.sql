...
INSERT INTO CHARACTER_ROLES_2 (CHAR_ROLE_ID_2, TITLE) VALUES (0, 'Not Applicable');
INSERT INTO CHARACTER_ROLES_2 (TITLE) VALUES ('Love Interest');
INSERT INTO CHARACTER_ROLES_2 (TITLE) VALUES ('Mentor');
...
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Collin', 'Gray', 5, 0, 'Collin is a junior in high school and is Jason''s younger brother. He''s also the Captain of the school''s soccer team, which makes him considerably more popular than his older brother.', 2, 16, 0);
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Meghan', 'Gray', 5, 0, 'Meghan is Jason''s mother. She has been raising her two boys, Jason and Collin, by herself since her husband Shawn left her 15 years ago.', 1, 45, -1);
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Shawn', 'Gray', 5, 0, 'Shawn is Jason''s father. He left his family 15 years ago after moving them to a new place. He has not been heard from since then and is presumed to be dead.', 2, 55, 4); 
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Hartley', 'Sinclair', 4, 1, 'Hartley ran away from home after her powers manifested. Believing herself to be dangerous and not wanting to put her family at risk if she were discovered, Hartley left her family and her hometown behind.', 1, 19, 2); 
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Roderick', 'Sinclair', 5, 0, 'Roderick is Hartley''s father.', 1, 50, -1);
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Madelyn', 'Sinclair', 5, 0, 'Madelyn is Hartley''s mother.', 1, 47, -1);
INSERT INTO CHARACTERS (FIRST_NAME, LAST_NAME, CHAR_ROLE_ID, CHAR_ROLE_ID_2, DESCRIPTION, SPECIES_ID, AGE, STAGE_ID) VALUES ('Luke', 'Flynn', 4, 2, 'Lucas "Luke" Flynn was bullied as child. Caught by Lucian Pierce, he was persuaded to work for the WPN and left after a decade. After he left, his family was attacked and he never forgave himself.', 2, 29, 4);
