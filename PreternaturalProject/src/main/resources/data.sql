...
INSERT INTO WEAPONS (WEAPON_NAME, WEAPON_DESCRIPTION) VALUES ('X Field', 'A field that affects a dome-shaped area. Preterhumans caught in this field will be unable to use their powers. After passing the field''s perimeter, they will be able to use their powers again.');
...
INSERT INTO WEAPONS (WEAPON_NAME, WEAPON_DESCRIPTION) VALUES ('Anti-Repair Suppression Bullet', 'An upgraded version of the Suppression Bullet that prevents Object Repair Specialist from repairing wounds inflicted with this weapon.');
